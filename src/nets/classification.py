...
class RopeEffnetV2s(LightningModule):
    ...
    def add_model_specific_args(parent_parser):
        ...
        group.add_argument("--bin_weights", type=float, nargs="+", default=[0.37735849, 0.56603774, 0.75471698, 1.41509434, 1.88679245], help='Bin weights for Ordinal EMD Loss')
    ...
    def on_validation_epoch_end(self):
        ...
        rec_top = recall[-1:].mean()

        val_select = rec_top - lam * fp_reject_075 - mu * fp_reject_090
